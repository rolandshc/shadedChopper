...
void initChopper() {
    ...
    sphereVAO = createSphere(1.0f, 32, 24, glm::vec3(1.0, 0.0, 0.0), chopperBodyTriangleCount);

    chopperVAO = createSphere(1.0f, 8, 6, glm::vec3(0.5, 0.5, 0.5), chopperBodyTriangleCount);
    firstBladeVAO = createCube(glm::vec3(0.933, 0.910, 0.667));
    secondBladeVAO = createCube(glm::vec3(0.933, 0.910, 0.667));
}
...
void drawChopper() {
    ...
    ms.push(ms.top());
        ms.top() = glm::translate(ms.top(), glm::vec3(0.0f, -4.0f, 2.0f)); //chopper transform

        ms.top() = glm::translate(ms.top(), glm::vec3(0.0f, 0.0f, -2.0f));

        ms.push(ms.top()); //body
            ms.top() = glm::scale(ms.top(), glm::vec3(3.0f, 1.0f, 2.0f)); //scale the body
            shader.uniformMatrix4fv("modelMatrix", ms.top());
        ...
        ms.push(ms.top());//blades
            ms.top() = glm::rotate(ms.top(),1.0f * (float)fmod(glfwGetTime(), 360.0), glm::vec3(0.0f, 1.0f, 0.0f));
            ms.top() = glm::translate(ms.top(), glm::vec3(0.0f, 1.0f, 0.0f)); //blades
            ms.top() = glm::scale(ms.top(), glm::vec3(3.0f, 0.1f, 0.1f ));  //scale the blades

            ms.push(ms.top());//1st blade
                ms.top() = glm::translate(ms.top(), glm::vec3(1.2f, 0.0f, 0.0f)); //blades
                shader.uniformMatrix4fv("modelMatrix", ms.top());
                glBindVertexArray(firstBladeVAO);
                glDrawArrays(GL_TRIANGLES, 0, 36);
            ms.pop();

            ms.push(ms.top());//2nd blade
                ms.top() = glm::translate(ms.top(), glm::vec3(-1.2f, 0.0f, 0.0f));
                shader.uniformMatrix4fv("modelMatrix", ms.top());
